/*
  ...
  gengetopt --file-name=client_opt 
...
const char *gengetopt_args_info_purpose = "An IP stack client";
...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --ip=STRING      IP adddress",
  "  -o, --option=STRING  Option",
  "  -f, --file=filename  File to use",
    0
};
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->option_given)
    {
      fprintf (stderr, "%s: '--option' ('-o') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVi:o:f:", long_options, &option_index);
